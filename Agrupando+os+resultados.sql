...
SELECT * FROM [ITENS NOTAS FISCAIS] WHERE QUANTIDADE = '99' AND [CODIGO DO PRODUTO] = '1101035'

SELECT [CODIGO DO PRODUTO], COUNT(*) FROM [ITENS NOTAS FISCAIS] WHERE QUANTIDADE = '99' AND [CODIGO DO PRODUTO] = '1101035' GROUP BY [CODIGO DO PRODUTO]
